...
namespace Game_Database_App.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,GameName,GameDesc")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,GameName,GameDesc")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
